...
export const authUi = {
  ...
  inputError: {
    borderColor: tournamentColors.errorInputBorder,
  ...
  stepPill: (active, done) => ({
    ...
    borderRadius: 10,
    alignItems: 'center',
    backgroundColor: done ? tournamentColors.chipSelectedBg : active ? tournamentColors.primary : tournamentColors.inputFill,
    borderWidth: 1,
    borderColor: done ? tournamentColors.primaryTint : active ? tournamentColors.primary : tournamentColors.borderLight,
  }),
  stepPillText: (active, done) => ({
    fontSize: 11,
    fontWeight: '700',
    color: done ? tournamentColors.statusInfoText : active ? tournamentColors.onPrimary || '#ffffff' : tournamentColors.mutedIcon,
  }),
  pinRow: {
    flexDirection: 'row',
  ...
  pinCell: (active, filled) => ({
    ...
    marginHorizontal: 3,
    borderWidth: 1,
    borderColor: active ? tournamentColors.primary : filled ? tournamentColors.primaryTint : tournamentColors.border,
    borderRadius: 12,
    backgroundColor: tournamentColors.surfaceAlt,
    alignItems: 'center',
    justifyContent: 'center',
